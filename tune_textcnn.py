...
def parse_args():
    ...
    parser.add_argument('--min_frequency', type=int, default=2,
                        help='Minimum word frequency to include in\
    ...
    parser.add_argument('--max_epochs', type=int, default=30,
                        help='Maximum number of epochs for hyperparameter \
                            search (default: 30)')
...
def main():
    ...
    # Define a trainable function for Ray 
    ...
    param_space = {
        "embed_dim": tune.choice([50, 100, 150, 200, 250, 300, 350, 400,
                                  450, 500]),
    ...
    print(f"Best trial final training accuracy:\
           {best_result.metrics['train_accuracy']}")
    print(f"Best trial final training loss:\
